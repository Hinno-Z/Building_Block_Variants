...
public class modWoodBlocks {
    ...
    public static final RegistryObject<Block> STRIPPED_OAK_LOG_WALL = registerBlock ("stripped_oak_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.OAK_PLANKS).mapColor (Blocks.STRIPPED_OAK_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_BIRCH_LOG_WALL = registerBlock ("stripped_birch_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.BIRCH_PLANKS).mapColor (Blocks.STRIPPED_BIRCH_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_SPRUCE_LOG_WALL = registerBlock ("stripped_spruce_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.SPRUCE_PLANKS).mapColor (Blocks.STRIPPED_SPRUCE_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_DARK_OAK_LOG_WALL = registerBlock ("stripped_dark_oak_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.DARK_OAK_PLANKS).mapColor (Blocks.STRIPPED_DARK_OAK_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_CHERRY_LOG_WALL = registerBlock ("stripped_cherry_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks. CHERRY_PLANKS).mapColor (Blocks.STRIPPED_CHERRY_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_ACACIA_LOG_WALL = registerBlock ("stripped_acacia_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.ACACIA_PLANKS).mapColor (Blocks.STRIPPED_ACACIA_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_JUNGLE_LOG_WALL = registerBlock ("stripped_jungle_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.JUNGLE_PLANKS).mapColor (Blocks.STRIPPED_JUNGLE_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_MANGROVE_LOG_WALL = registerBlock ("stripped_mangrove_log_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.MANGROVE_PLANKS).mapColor (Blocks.STRIPPED_MANGROVE_WOOD.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_BAMBOO_BLOCK_WALL = registerBlock ("stripped_bamboo_block_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.BAMBOO_PLANKS).mapColor (Blocks.STRIPPED_BAMBOO_BLOCK.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_WARPED_STEM_WALL = registerBlock ("stripped_warped_stem_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.WARPED_PLANKS).mapColor (Blocks.STRIPPED_WARPED_STEM.defaultMapColor ())));
    ...
    public static final RegistryObject<Block> STRIPPED_CRIMSON_STEM_WALL = registerBlock ("stripped_crimson_stem_wall",
            () -> new WallBlock (BlockBehaviour.Properties.copy (Blocks.CRIMSON_PLANKS).mapColor (Blocks.STRIPPED_CRIMSON_STEM.defaultMapColor ())));
